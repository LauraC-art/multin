    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-sm" style={{
            ...
            ><a class="url-links" href="https://www.youtube.com/watch?v=nF9EAQRgAbA"><h1>Lo que necesitas</h1></a>
            </animated.div>
          </div>
          ...
          <div class="col-sm" style={{
            ...
            >
              <a class="url-links" href="https://www.youtube.com/watch?v=OLstu58Vevg">
          ...
          <div class="col-sm" style={{
            ...
            >
              <a class="url-links" href="https://www.umng.edu.co/programas/pregrados/ingenieria-multimedia">
